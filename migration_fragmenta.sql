-- ============================================================
-- Financiación de la entrega con Fragmenta
...
ALTER TABLE payment_plans
  ADD COLUMN IF NOT EXISTS fragmenta_plazo    INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS fragmenta_comision NUMERIC(10,2) NOT NULL DEFAULT 0;

-- 0 = la entrega no se financia. El resto, los plazos que ofrece Fragmenta.
ALTER TABLE payment_plans
  DROP CONSTRAINT IF EXISTS payment_plans_fragmenta_plazo_chk;
ALTER TABLE payment_plans
  ADD CONSTRAINT payment_plans_fragmenta_plazo_chk
  CHECK (fragmenta_plazo IN (0, 3, 5, 10, 12));
